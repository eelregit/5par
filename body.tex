...
agreement with the conventional $\tanh$ model (gomp 0 and $\tanh$ 0 in \Cref{tab:uber-table}).
...
%\YL{[The latter is less likely given how the Sobol sampling and SR work,
%right?]} \paulo{Indeed, but the reionization community will appreciate
%the latter option, so I suggest we keep the language as is.}
...
Planck.
See \Cref{fig:unleashed_gomp,tab:uber-table} in the Extended Data for details.
...
\caption{\textbf{Optical depth evolution $\tau_\reio$ and reionization history $x_\HI$.}
...
The shaded regions in the upper panel correspond to the inferred range in $\tau$ 
from analyzing Planck PR3 data. Additionally, the lower panel includes observational 
constraints from high-redshift quasars \cite{Greig2017, Banados2018, Davies2018, 
Greig2019, Wang2020, Yang2020, Greig2022, Jin2023} and galaxies \cite{Ouchi2010,
