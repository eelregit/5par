...
can be written as \paulo{... think if we want to keep this with +astro or remove it}
%
\begin{equation}
\label{eq:premise}
x_\HI(a) = f(a; \sigma_8, \ns, h, \Omegab, \Omegam)
...
universal shape for $x_\HI$ using 512 Sobol samples of \texttt{21cmFAST} simulations. 
...
the cosmological parameters, determines the pivot and tilt values, and consequently
the reionization history, $\tau_\reio$, and CMB angular
power spectra.
...
include astrophysical data (see \nameref{ssec:xHI}) to effectively
...
constraints increase, we anticipate significant cosmological gains within
our framework.