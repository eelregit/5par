...
in \cite{Neal2005}.} \cite{Lewis2002, Lewis2013}\YLtodo{dragging? fast-slow? vs cov}, showcasing its ability to
...
where $\vtheta$ denotes to cosmological parameters\YLtodo{clarify notation w or wo $\zetaUV$}, $\ap(\vtheta)$
is the power-law pivot (or logarithmic translation), and $\tilt = 8.290$
is the rescaling tilt, which, according to our 21cmFAST simulations,
appears constant.
...
The sampler runs until the Gelman-Rubin statistic \cite{Lewis2013}\YLtodo{cite Gelman and Rubin instead}
...
cosmology dependence, we use 128 Sobol samples of 21cmFAST simulations\YLtodo{should probably appear earlier}
...
\YLtodo[inline]{explain blue thin dotted tanh}
