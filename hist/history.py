...
# the curves
ax1.plot(1+z, xHI(z,sigma8=0.8092,ns=0.9634,h=0.6722,Ob=val,Om=0.3171,model='0227'),  '--', c='green', linewidth=3, label=r'Gompertz', zorder=7)
ax1.plot(1+z, xHI(z,sigma8=0.8092,ns=0.9634,h=0.6724,Ob=val2,Om=0.3168,model='0226'),  ':', c='pink', linewidth=3, label=r'Gompertz.5', zorder=8, alpha=0.8)
ax1.axvline(x=5.90, ls='dashed', c='purple')
ax1.plot(1+z,(1.0 - tanH_model(7.67 - 0.75, z)),':',c='darkblue',label=r'Tanh',zorder=5)
ax1.plot(1+z,(1.0 - tanH_model(7.67 + 0.75, z)),':',c='darkblue',zorder=5)
ax1.plot(1+z,(1.0 - tanH_model(7.67, z)),linewidth=3,c='darkblue',zorder=5)
