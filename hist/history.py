...
z = np.linspace(5.5,12,100)
b = 0.7
plt.style.use('../5par.mplstyle')
fig = plt.figure(figsize=(4.8, 3.2))
ax1 = fig.add_subplot(111)
# the curves
ax1.plot(z, xHI(z,sigma8=0.8092,ns=0.9634,h=0.6722,Ob=val,Om=0.3171,model='0227'),  '--', c='green', linewidth=3, label=r'Gompertz', zorder=7)
ax1.plot(z, xHI(z,sigma8=0.8092,ns=0.9634,h=0.6724,Ob=val2,Om=0.3168,model='0226'),  ':', c='pink', linewidth=3, label=r'Gompertz.5', zorder=8, alpha=0.8)
ax1.axvline(x=5.90, ls='dashed', c='purple')
ax1.plot(z,(1.0 - tanH_model(7.67 - 0.75, z)),':',c='darkblue',label=r'Tanh',zorder=5)
ax1.plot(z,(1.0 - tanH_model(7.67 + 0.75, z)),':',c='darkblue',zorder=5)
ax1.plot(z,(1.0 - tanH_model(7.67, z)),linewidth=3,c='darkblue',zorder=5)
#ax1.errorbar(5.9,0.11,0.06,uplims=True,marker='o',markersize=7, ls='none', label=r'Dark Pixel 2015',zorder=6, alpha=b)
ax1.errorbar(6.3,0.79,0.04,uplims=True,marker='o', c='gold', markersize=7, ls='none', label=r'Dark Pixel 2023',zorder=6, alpha=b)
ax1.errorbar(6.5,0.87,0.03,uplims=True,marker='o', c='gold', markersize=7, ls='none', zorder=6, alpha=b)
ax1.errorbar(6.7,0.94,0.09,uplims=True,marker='o', c='gold', markersize=7, ls='none', zorder=6, alpha=b)
ax1.errorbar(6.1,0.69,0.06,uplims=True,marker='o', c='gold', markersize=7, ls='none', zorder=6, alpha=b)
ax1.errorbar(6.9,0.4,0.1,uplims=False,lolims=True,marker='s',markersize=7, ls='none', label=r'Ly$\alpha$ Fraction',zorder=6, alpha=b)
ax1.errorbar(6.6,0.5,0.1,uplims=True,lolims=False,marker='*',markersize=7, ls='none', label=r'LAE Clustering',zorder=6, alpha=b)
ax1.errorbar(7.,0.7,yerr=np.array([[0.23,0.20]]).T,uplims=False,marker='p',markersize=7,capthick=2,capsize=4, ls='none', label=r'J0252-0503',zorder=6, alpha=b)
ax1.errorbar(7.5,0.39,yerr=np.array([[0.13,0.22]]).T,uplims=False,marker='p',markersize=7,capthick=2,capsize=4, ls='none', label=r'J1007+2115',zorder=6, alpha=b)
ax1.errorbar(7.1,0.4,yerr=np.array([[0.19,0.21]]).T,uplims=False,marker='p',markersize=7,capthick=2,capsize=4, ls='none', label=r'J1120+0641',zorder=6, alpha=b)
ax1.errorbar(7.5,0.21,yerr=np.array([[0.19,0.17]]).T,uplims=False,marker='p',markersize=7,capthick=2,capsize=4, ls='none', label=r'J1342+0928a',zorder=6, alpha=b)
# this is really a 7.5 that I moved, so let's put it back
ax1.errorbar(7.5,0.56,yerr=np.array([[0.18,0.21]]).T,uplims=False,marker='p',markersize=7,capthick=2,capsize=4, ls='none', label=r'J1342+0928b',zorder=6, alpha=b)
# lets also move this one back to 7.5
ax1.errorbar(7.5,0.60,yerr=np.array([[0.23,0.20]]).T,uplims=False,marker='p',markersize=7,capthick=2,capsize=4, c='rosybrown', ls='none', label=r'J1342+0928c',zorder=6, alpha=b)
ax1.errorbar(7.1,0.48,yerr=np.array([[0.26,0.26]]).T,uplims=False,marker='p',markersize=7,capthick=2,capsize=4, c='rosybrown', ls='none', label=r'J1120+0641',zorder=6, alpha=b)
ax1.errorbar(7.29,0.49,yerr=np.array([[0.11,0.11]]).T,uplims=False,marker='p',markersize=7,capthick=2,capsize=4, ls='none', label=r'Combined quasars',zorder=6, alpha=b)
ax1.errorbar(7.0,0.59,yerr=np.array([[0.15,0.11]]).T,xerr=0.5,uplims=False,marker='d',markersize=7,capthick=2,capsize=4, ls='none', label=r'Ly$\alpha$ EWa',zorder=6, alpha=b)
ax1.errorbar(7.6,0.88,yerr=np.array([[0.10,0.05]]).T,xerr=0.6,uplims=False,marker='d',markersize=7,capthick=2,capsize=4, ls='none', label=r'Ly$\alpha$ EWb',zorder=6, alpha=b)
ax1.errorbar(8.0,0.76,yerr=0.22,xerr=0.6,uplims=False,lolims=True,marker='d',markersize=7,capthick=2,capsize=4, ls='none', label=r'Ly$\alpha$ EWc',zorder=6, alpha=b)
...
line_legend = ax1.legend(handles[:3], labels[:3], loc='lower right')
ax1.add_artist(line_legend)
ax1.legend(handles[3:], labels[3:], loc='center left', bbox_to_anchor=(1.,0.5))
#plt.colorbar(mappable, label=r'$\Omega_{\mathrm{b}}$', ax=ax1, fraction=0.046, pad=0.04)
