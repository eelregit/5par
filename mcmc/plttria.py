...
def triangle_plot(*roots):
    ...
    for param in ['m_ncdm', 'w0_fld', 'wa_fld', 'z_reio', 'zt',
                  'chi2__bao.desi_2024_bao_all',
                  'chi2__sn.desy5', 'chi2__sn.pantheonplusshoes', 'chi2__sn.union3',
                  'chi2__xHI', 'chi2__planck_2018_lowl.EE']:
        for s in samples:
