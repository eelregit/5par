...
\label{ssec:fits}
Table \Cref{tab:uber-table}\PMCtodo{Any better name for this subsection one?} summarizes the
...
CMB cosmological parameters (see shaded parameters in Table \Cref{table:uber-table}). In contrast, 
