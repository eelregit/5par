...
Our \texttt{21cmFAST} simulations have a 300 comoving Mpc\YLtodo{no $h$?}\PMCtodo{Indeed no h.} box size and
...
fraction too? Good ref on this?} \PMCtodo{Sorry, I do not understand the question. C essentially appears because of $Y_\He$. The other C that you mention would be the same C (He to H) or you mean another ratio?}  \paulo{In case it helps: $n_{He} / n_H = \rho_{He}/ (m_{He}/m_H \rho_H) = Y_{He} \rho_b / (C (1 - Y_{He}) \rho_b) = Y_{He} / (C (1 - Y_{He}))$ and C is different than 4 because of binding energies.}
%
\begin{equation}
\label{eq:xe_H_He}
