...
\midrule
$10^{9} \As$ &  \sampled 2.100(30) & \sampled 2.099(30) & \sampled 2.101(31) & & 2.094(13) & & & 2.112(12) \\
$\ns$ & \sampled 0.9649(42) & \sampled 0.9641(42) & \sampled 0.9640(42) & & \sampled 0.9636(39) & & & \sampled 0.9646(38) \\
$\Omegac h^2$ & \sampled 0.1200(12) & \sampled 0.1201(12) & \sampled 0.1200(12) & & \sampled 0.1202(11) & & & \sampled 0.1202(10) \\
$\Omegab h^2$ & \sampled 0.02237(15) &  \sampled 0.02235(15) & \sampled 0.02235(15) & & \sampled 0.02234(14) & & & \sampled 0.02234(14) \\
$\Omegam$ & 0.3153(73) & 0.3157(76) & 0.3155(75) & & 0.3166(69) & & & 0.3162(63) \\
...
$H_0$ & 67.36(54) & 67.32(55) & 67.34(55)  & & \sampled 67.26(50) & & & \sampled 67.29(46) \\
$100 \theta_\mathrm{X}$ & \sampled 1.04092(31) & \sampled 1.04815(29) & \sampled 1.04185(29) & & 1.04184(29) & & & 1.04185(29) \\
$\sigma_8$ & 0.8111(60) & 0.8108(60) & 0.8109(60) & & \sampled 0.8100(44) & & & \sampled 0.8138(40) \\
$S_8$ & 0.832(13) & 0.832(13) & 0.832(13) & & 0.832(13) & &  &0.836(12) \\
$\tau_\reio$ & \sampled 0.0544(73) & \sampled 0.0543(75) & \sampled 0.0547(76) & & 0.0526(15) & & & $0.05720_{(77)}^{(88)}$ \\
...
and $\sigma_8$ primarily leads to an earlier reionization scenario, 
while a higher value of $\Omegab$ delays reionization. Besides, the ratio of
matter densities appears in the pivot expression once again. Among the
discrepancies, we note that the role of $h$ generally shows the opposite
trend in $\alpha$. Furthermore, \cref{eq:SRHalf_b} does not include $\ns$
nor $\sigma_8$ because of our choice of complexity for SRHalf, which 
although less convoluted also hosts a larger loss than SRFull. Nevertheless,
the two models have close enough mean squared errors to reproduce the 
simulated data.
...
and luminosity function (LF) constraints on $x_\HI (z)$ (see \Cref{fig:history}).

For  inference purpose (\nameref{ssec:fits}), DW data includes DW constrains, 
