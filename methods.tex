...
It was immediatly obviously\PMCtodo{immediately obvious} to us that the $x_\HI$'s had a common shape
...
the nearby models above the segment.
...
model that samples over $z_\re$.'' or similar.}}
...
parameters ($\sigma_8$ instead of $A_s$, $H_0$ instead of $\theta_{mc}$, and $z_{\rm re}$ instead of $\tau_\reio$). As such, I insist on keeping it.}}
