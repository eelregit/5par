...
\end{align}
%
The distribution of our simulations is displayed in \Cref{fig:sobol}.

\begin{figure}
\centering
\includegraphics[width=25em]{figs/sobol128.pdf}
\caption{\textbf{Sobol sampling of our $x_\HI$ profiles}.
Each point corresponds to a run of \texttt{21cmFAST} with the
corresponding values of $\sigma_8, \ns, h, \Omegab, \Omegam, \zetaUV$.}
\label{fig:sobol}
\end{figure}

Our \texttt{21cmFAST} simulations have a 300 comoving Mpc box side and $768^3$
...
To include the impact of helium reionization in our Gompertz
...
polynomial fit presented in \cref{eq:uni}.
