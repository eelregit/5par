...
likely to change with more high-$z$ data. \paulo{revisit later for LF rephrase.}
...
$\tanh$ reionization does a poor job of fitting the data, with a 
$\chi^2$ larger than Gompertz's by an order of magnitude,
hence we do not show the $\tanh$ results in
 \Cref{tab:uber-table}.
