...
\end{equation}
All such expressions lie on the lower convex hull\footnote{This aid for
model selection is similar to the concept of hypervolume of the Pareto
front used in \cite{Cao2015}.} of the Pareto front, as illustrated in
\Cref{fig:pareto}.
